...
for i = 1 : length(problems)
    ...
    parfor k=1:n_folds
        ...
        [CM, output] = buildComposedMap(YXtrain, max_iter, component);
        test_case = ['data/' problems{i} '_cv_fold' num2str(k) '.mat'];
        % save results
        points = struct;
        points.training = YXtrain;
        points.test = YXtest;
...
function [CM, output] = buildComposedMap(Xtrain, max_iter, components)
